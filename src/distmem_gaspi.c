...
static void put_info_entry_into_state(struct distmem * dist_kind, void * local_buffer, int procs_distributed_over, size_t element_size,
	...
	struct distmem_gaspi_memory_information* specific_state=(struct distmem_gaspi_memory_information*) memkind_malloc(MEMKIND_DEFAULT, sizeof(struct distmem_gaspi_memory_information));
